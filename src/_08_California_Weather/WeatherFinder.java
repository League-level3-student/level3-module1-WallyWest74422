...
//String cityName =	JOptionPane.showInputDialog("Enter California city name");
//// u.capitalizeWords( cityName );{
...
//}
 //HashMap<String, WeatherData> getWeatherData;(cityName); {
...
//     return weatherData;
// }
// HashMap<String, WeatherData> weatherData = u.getWeatherData();
